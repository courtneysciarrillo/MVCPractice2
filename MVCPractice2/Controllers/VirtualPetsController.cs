...
namespace MVCPractice2.Controllers
{
    public class VirtualPetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "VirtualPetID,Name,Age,Hunger,Type,Thirst,color")] VirtualPet virtualPet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VirtualPetID,Name,Age,Hunger,Type,Thirst,color")] VirtualPet virtualPet)
        {
            if (ModelState.IsValid)
            {
